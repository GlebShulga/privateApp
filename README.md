...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/experience](http://localhost:3000/experience). This endpoint can be edited in `pages/experience.tsx`.
