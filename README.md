...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/cv](http://localhost:3000/api/hello). This endpoint can be edited in `pages/cv.tsx`.
