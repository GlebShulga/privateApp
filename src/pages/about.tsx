    ...
    <section className={styles.container}>
      ...
      <div>
        <p>
          ...
          creating things that live on the internet. During my career, I&apos;ve
          had the opportunity to work on a variety of exciting projects that
          have helped me hone my skills and gain valuable experience.
        </p>
        <p>
          ...
          I have also developed custom booking forms for hotels, which has
          significantly improved website navigation. My commitment to
          accessibility is strong, and I have conducted audits and adaptations
          for e-commerce platforms to ensure A11y compliance, making websites
          more accessible for users with disabilities. I have also used Tailwind
          to fix responsiveness issues, ensuring that websites are fully
        ...
        <p>
          ...
          demonstrating my ability to create successful solutions that meet the
